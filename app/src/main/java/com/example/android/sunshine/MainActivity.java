...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static int SUNSHINE_LOADER = 101;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Loader loader = manager.getLoader(SUNSHINE_LOADER);

        if (loader == null){
            manager.initLoader(SUNSHINE_LOADER, savedInstanceState, this);
        } else {
            manager.restartLoader(SUNSHINE_LOADER, savedInstanceState, this);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            if (loader == null){
                manager.initLoader(SUNSHINE_LOADER, null, this);
            } else {
                manager.restartLoader(SUNSHINE_LOADER, null, this);
            }
            loadWeatherData();
            return true;
        }
