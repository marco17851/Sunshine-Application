...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)){
            case CODE_WEATHER:
                String allRows = "1";
                rowsDeleted = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, allRows, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown URI. Please try later: " + uri.toString());
        }
