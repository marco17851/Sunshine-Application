...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)){
            case CODE_WEATHER:
                returnedCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
            ...
            case CODE_WEATHER_WITH_DATE:
                ...
                String[] mArgs = {date};
                returnedCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, mSelection, mArgs, null, null, sortOrder);
                break;
            default:
                throw new UnsupportedOperationException("Uknown URI. Please try again: " + uri.toString());
        }
