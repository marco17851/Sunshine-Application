...
public class SunshineSyncUtils {
    ...
    private static final int SYNC_TIME_IN_SECONDS = 10800;
    private static final int FLEX_TIME_IN_SECONDS = 10800;
    ...
    private static void scheduleWeatherSync(Context context){
        ...
        Job job = dispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(SYNC_TIME_IN_SECONDS, SYNC_TIME_IN_SECONDS + FLEX_TIME_IN_SECONDS))
